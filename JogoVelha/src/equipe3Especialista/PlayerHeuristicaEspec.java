 ...
 */
public class PlayerHeuristicaEspec extends AbstractPlayer{
    
    public PlayerHeuristicaEspec(int depth) {
		super(depth);
	}
    ...
    public int heuristicaDiagonais(JogoVelha jogo, Jogada a, int marcajogador, int marcaoponente){
        ...
        //Se oponente começa em alguns dos cantos, não deixa o oponente ganhar.
        if(((diagonal1==1)&&(diagonalOponente1==2))&&(diagonal2==2)){
        	valor-=5;
        }
        if(((diagonal2==1)&&(diagonalOponente2==2))&&(diagonal1==2)){
        	valor-=5;
        }
        return valor;
    }
