...
public class PlayerVelha extends AbstractPlayer{
    ...
    public int heuristicaRetas(JogoVelha jogo, Jogada a, int marcajogador, int marcaoponente){
    	...
    	for(int i=0;i<jogo.tam;i++){
            ...
            if((linha==2)&&(linhaOponente==0)){
                valor+= 50;
            }else if((linha==1)&&(linhaOponente==0)){
            	valor+=10;
            }
            if((coluna==2)&&(linhaOponente==0)){
            	valor+= 50;
            }else if((coluna==1)&&(colunaOponente==0)){
                valor+= 10; 
            }
            linha=0;
            coluna=0;
    ...
    public int heuristicaDiagonais(JogoVelha jogo, Jogada a, int marcajogador, int marcaoponente){
        ...
        if((diagonal1==2)&&(diagonalOponente1==0)){
            valor+= 50;
        }else if((diagonal1==1)&&(diagonalOponente1==0)){
        	valor+=10;
        }
        if((diagonal2==2)&&(diagonalOponente2==0)){
        	valor+=50;
        }else if((diagonal2==1)&&(diagonalOponente2==0)){
            valor+= 10;
        }
        return valor;
    }
