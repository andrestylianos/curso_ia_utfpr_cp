...
//        t.stop();
  ...
  public static boolean trueOrFalse(String bool){
	  if(bool.equals("1")){
		  return true;
	  }else{
		  return false;
  ...
  public static void main(String[] args) throws ClassNotFoundException {
    ...
    PacManPlayer pacMan = new player.DFSPacManPlayer();
    if(argMap.containsKey("-heuristicas")){
    	String heuristicasOnOff = (String) argMap.get("-heuristicas");
        String[] heuristicasOnOffArray = heuristicasOnOff.split(",");
        pacMan.setH1(Game.trueOrFalse(heuristicasOnOffArray[0]));
        pacMan.setH2(Game.trueOrFalse(heuristicasOnOffArray[1]));
        pacMan.setH3(Game.trueOrFalse(heuristicasOnOffArray[2]));
        pacMan.setH4(Game.trueOrFalse(heuristicasOnOffArray[3]));
        pacMan.setH5(Game.trueOrFalse(heuristicasOnOffArray[4]));
        pacMan.setH6(Game.trueOrFalse(heuristicasOnOffArray[5]));
        pacMan.setH7(Game.trueOrFalse(heuristicasOnOffArray[6]));
        pacMan.setH8(Game.trueOrFalse(heuristicasOnOffArray[7]));
        pacMan.setH9(Game.trueOrFalse(heuristicasOnOffArray[8]));
        pacMan.setH10(Game.trueOrFalse(heuristicasOnOffArray[9]));
        pacMan.setH11(Game.trueOrFalse(heuristicasOnOffArray[10]));
        pacMan.setH12(Game.trueOrFalse(heuristicasOnOffArray[11]));
        pacMan.setH13(Game.trueOrFalse(heuristicasOnOffArray[12]));
